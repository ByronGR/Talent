...
Reason: `+$)}const d=i.status==="fulfilled"?i.value:[],c=l.status==="fulfilled"?l.value:[];let p=[];try{p=await Da(e.uid,e.email,(r==null?void 0:r.candidateCode)||(r==null?void 0:r.code)||"")}catch($){console.warn($)}const u=he();if(u&&!p.some($=>$.id===u)){const $=await _a(u,e.uid,e.email,(r==null?void 0:r.candidateCode)||(r==null?void 0:r.code)||"").catch(()=>null);$&&(p=[$,...p])}const v=sessionStorage.getItem("nw_new_account")==="1";v&&sessionStorage.removeItem("nw_new_account");const h=!!(r!=null&&r.targetRole||!na(r==null?void 0:r.headline)&&(r!=null&&r.headline)),M=new URLSearchParams(window.location.search).get("from")==="jobs",A=!!(r!=null&&r.cvUrl||(a=r==null?void 0:r.applications)!=null&&a.length||((n=r==null?void 0:r.skills)==null?void 0:n.length)>=3),x=(r==null?void 0:r.onboarded)||h||A||M;!(r!=null&&r.onboarded)&&x&&(r!=null&&r.candidateCode)&&Ct(e.uid,{onboarded:!0,candidateCode:r.candidateCode}).catch(()=>null);const k=v&&!x?"onboarding":x?tt():"onboarding";S({candidate:{...r||{},name:(r==null?void 0:r.name)||e.displayName||"Talent member",email:(r==null?void 0:r.email)||e.email,availability:(r==null?void 0:r.availability)||"open",headline:(r==null?void 0:r.headline)||(r==null?void 0:r.targetRole)||"Nearwork candidate"},applications:d,assessments:p,jobs:c.map(Se),loading:!1,view:"dashboard",activePage:k,message:""}),fetch("/api/intercom-token",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({userId:e.uid,email:e.email})}).then($=>$.ok?$.json():null).then($=>{$!=null&&$.token&&window.Intercom&&window.Intercom("boot",{api_base:"https://api-iam.intercom.io",app_id:"pelltlav",intercom_user_jwt:$.token,user_id:e.uid,name:(r==null?void 0:r.name)||e.displayName||"",email:e.email,session_duration:864e5})}).catch(()=>{}),V&&V(),we&&(V=Ha(e.uid,$=>{o.notifications=$,o.view==="dashboard"&&!o.message&&da()}))}catch(s){console.warn(s),S({candidate:{name:e.displayName||"Talent member",email:e.email,availability:"open",headline:"Nearwork candidate"},applications:[],assessments:[],jobs:[],loading:!1,view:"dashboard",activePage:tt(),message:""})}}async function je(){if(window.location.pathname==="/reset-password"){V&&V(),V=null,S({user:null,candidate:null,loading:!1,view:"reset-password",resetCodeStatus:null});return}const e=tt();if(e==="assessment"){sessionStorage.setItem("nw_restore_path",window.location.pathname),S({user:null,candidate:null,applications:[],assessments:[],jobs:[],loading:!1,view:"login",activePage:"overview",message:"Please log in to open your assessment."});return}if(e==="overview"){V&&V(),V=null,S({user:null,candidate:null,loading:!1,view:"login",activePage:"overview"});return}let t=[];try{const a=await Yt();a.length&&(t=a.map(Se))}catch(a){console.warn(a)}S({user:null,candidate:null,applications:[],assessments:[],jobs:t,loading:!1,view:"login",activePage:"overview",message:"Please log in to view your profile, matched openings, applications, and assessments."})}function rn(){return[{label:"My journey",items:[["overview","layout-dashboard","Overview"],["applications","send","Applications"],["assessment","clipboard-check","Assessment"]]},{label:"My search",items:[["matches","briefcase-business","Matches"],["cvs","files","CV Picker"]]},{label:"Support",items:[["tips","book-open","Tips"],["recruiter","calendar-days","Recruiter"],["profile","user-round-cog","Profile"]]}]}function ln(){var e;return{open:"Open to roles",interviewing:"Interviewing",paused:"Not looking"}[((e=o.candidate)==null?void 0:e.availability)||"open"]||"Open to roles"}function Pt(){const e=o.candidate||{},t=Qe();return[{id:"name",label:"Full name",done:!!e.name},{id:"role",label:"Target role",done:!!(e.targetRole||!na(e.headline)&&e.headline)},{id:"location",label:"City",done:!!e.city},{id:"salary",label:"Salary",done:!!(e.salaryAmount||e.salary)},{id:"english",label:"English",done:!!e.english},{id:"whatsapp",label:"WhatsApp",done:!!(e.whatsapp||e.phone)},{id:"skills",label:"Skills (5-20)",done:t.length>=5},{id:"cv",label:"CV",done:!!e.cvUrl}]}function da(){var l,r,d,c,p;const e=(o.notifications||[]).filter(u=>!u.read).length,t=((l=o.candidate)==null?void 0:l.availability)||"open",n={open:"#10A07C",interviewing:"#EAB308",paused:"#9AA0A6"}[t]||"#10A07C",s=((r=o.candidate)==null?void 0:r.name)||((d=o.user)==null?void 0:d.displayName)||"Talent member",i=((c=o.candidate)==null?void 0:c.headline)||((p=o.candidate)==null?void 0:p.targetRole)||"Nearwork candidate";st.innerHTML=`
  ...
  `,Ie(),Zn(),mn(),pn()}function cn(e){return(e!=null&&e.toDate?e.toDate():new Date(e||Date.now())).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}function dn(){const e=(o.notifications||[]).slice(0,10);return`
  ...
  `}function un(){var a;const e=((a=o.candidate)==null?void 0:a.notificationPreferences)||{};return`
  ...
  `}let Ye=null;function pn(){Ye&&window.clearInterval(Ye);const e=document.querySelector("#assessmentTimer");if(!e)return;const t=new Date(e.dataset.end||"").getTime(),a=()=>{const n=Math.max(0,t-Date.now()),s=Math.floor(n/1e3),i=Math.floor(s/60),l=String(s%60).padStart(2,"0");e.textContent=`${i}:${l}`,e.classList.toggle("is-low",n<=10*60*1e3),n<=0&&window.clearInterval(Ye)};a(),Ye=window.setInterval(a,1e3)}function mn(){if(o.activePage!=="assessment")return;const e=o.assessments||[],t=he(),n=(t?e.find(i=>i.id===t):null)||e.find(i=>["sent","started"].includes(String(i.status||"").toLowerCase()));if(!(n!=null&&n.id))return;const s=String(n.status||"").toLowerCase();if(s==="started"&&ea()===null){Te(n.id,Number(n.currentQuestionIndex||0),!0);return}if(!t&&s==="sent"){const i=`/assessment/${encodeURIComponent(n.id)}/start`;window.history.replaceState({page:"assessment",assessmentId:n.id},"",i)}}function gn(){return({onboarding:vn,overview:Ft,matches:Sn,applications:Cn,assessment:$n,cvs:_n,tips:Rn,recruiter:Un,profile:Bn}[o.activePage]||Ft)()}function Ft(){var A,x;const e=ua(),t=Pt(),a=t.filter(k=>k.done).length,n=t.length,s=o.applications||[],i=s.filter(k=>["action-needed","interview-scheduled","assessment-sent"].includes(String(k.status||"").toLowerCase())).length,l=(o.jobs||[]).slice(0,3),r=((A=o.candidate)==null?void 0:A.recruiter)||{},d=2*Math.PI*52,c=d*(1-e/100),u=new Date().toLocaleDateString("en-US",{weekday:"long",month:"long",day:"numeric"}),v=(k,$,R,z,U)=>`
    <div class="nw-stat-tile">
    ...
    </div>`,h=(k,$)=>{const R=String(k.stage||k.status||"applied").toLowerCase(),z=R.includes("offer")?4:R.includes("final")?3:R.includes("interview")?2:R.includes("assessment")?1:0,U=k.clientName||k.company||"Nearwork client",q=U.split(/\s+/).slice(0,2).map(f=>f[0]).join("").toUpperCase(),Z=["#10A07C","#EC4E7E","#3B82F6","#F4A52E","#8B5CF6"],Y=Z[U.length%Z.length];return`
      <div class="nw-app-row${$?" last":""}">
        <div class="nw-app-avatar" style="background:${Y};">${q}</div>
        <div class="nw-app-info">
          <div class="nw-app-title">${E(k.jobTitle||k.title||"Application")} <span class="nw-app-company">· ${E(U)}</span></div>
          <div class="nw-app-stages">
            ${Kt.map((f,g)=>`<div class="nw-stage-pip${g<=z?" done":""}"></div>`).join("")}
        ...
        <div class="nw-app-meta">
          ...
          <div class="nw-app-date">${it(k.updatedAt||k.createdAt)}</div>
        </div>
        ${m("chevron-right")}
      </div>`},M=k=>{const $=Se(k),R=At($),z=$.match||(R.length>=3?Math.min(97,70+R.length*4):null),U=["#10A07C","#EC4E7E","#3B82F6","#F4A52E"],q=U[$.orgName.length%U.length],Z=$.orgName.split(/\s+/).slice(0,2).map(Y=>Y[0]).join("").toUpperCase();return`${encodeURIComponent($.code)}`,`
      <div class="nw-match-card">
        ...
        ${R.length?`<div class="nw-match-why">${R.slice(0,3).map(E).join(" · ")} match</div>`:`<div class="nw-match-why">${E($.description).slice(0,80)}…</div>`}
        <div class="nw-match-footer">
          <span class="nw-match-salary">${E($.compensation)}</span>
          <button type="button" class="nw-match-apply" data-apply="${w($.code)}">Apply ${m("arrow-right")}</button>
        </div>
      </div>`};return`
    <!-- Greeting -->
  ...
  `}function vn(){if(!ze){ze=!0,kt=1;const e=o.candidate||{},t=String(e.name||"").trim().split(/\s+/).filter(Boolean);P={roleGroup:e.roleGroup||"",targetRole:e.targetRole||"",department:e.department||e.locationDepartment||"",city:e.city||e.locationCity||"",english:e.english||"",firstName:e.firstName||t[0]||"",lastName:e.lastName||t.slice(1).join(" ")||"",phone:e.phone||e.whatsapp||"",currentRole:e.currentRole||"",expectedSalaryUSD:e.expectedSalaryUSD||(e.salaryCurrency!=="COP"?e.salaryAmount:null)||"",expectedSalaryCOP:e.expectedSalaryCOP||(e.salaryCurrency==="COP"?e.salaryAmount:null)||"",linkedin:e.linkedin||"",experience:Array.isArray(e.workHistory)?e.workHistory.map(a=>({...a})):[],languages:Array.isArray(e.languages)?[...e.languages]:[],skills:Array.isArray(e.skills)?[...e.skills]:[],certifications:Array.isArray(e.certifications)?e.certifications.map(a=>({...a})):[]},re=null,Ve=null,_=null}return'<div id="onboardingWizard" class="onb-shell"></div>'}function fn(){document.querySelector("#onboardingWizard")&&He(kt)}function He(e){kt=e;const t=document.querySelector("#onboardingWizard");t&&(t.innerHTML=hn(e),wn(e))}function mt(e){return`
    ...
    <button type="button" id="onbNext" class="primary-action fit">${t||"Continue →"}</button>
  </div>`}function hn(e){var a,n,s,i;const t=P;switch(e){case 1:{const l=!!re;return`
        <div class="onb-step">
          ${mt(1)}
        ...
        <div class="onb-step">
          ...
          <div style="display:grid;gap:12px;margin-bottom:4px;">
            ${te("Area",!1,`<select id="onbRoleGroup" style="font-size:14px;padding:10px 12px;border:1.5px solid var(--border);border-radius:8px;background:#fff;outline:none;">${sa(l)}</select>`)}
    ...
    <div class="onb-step">
      ...
      <button type="button" class="onb-list-remove" aria-label="Remove" style="${Et}">×</button>`,n.querySelectorAll("input[data-k]").forEach(s=>{s.addEventListener("input",i=>{t[i.target.dataset.k]=i.target.value})}),n.querySelector(".onb-list-remove").addEventListener("click",()=>{P.certifications.splice(a,1),St()}),e.appendChild(n)}))}function wn(e){var n,s,i,l,r;const t=document.querySelector("#onbBack"),a=document.querySelector("#onbNext");switch(t==null||t.addEventListener("click",()=>He(e-1)),e){case 1:{const d=document.querySelector("#onbCvInput"),c=document.querySelector("#onbCvStatus"),p=document.querySelector("#onbSkipCv");re&&d&&(a.disabled=!1),d==null||d.addEventListener("change",()=>{var v;const u=(v=d.files)==null?void 0:v[0];u&&(re=u,c&&(c.textContent=`✓ ${u.name}`),a.disabled=!1,_=null,Ve=$t(u).catch(()=>null))}),a==null||a.addEventListener("click",()=>gt(2)),p==null||p.addEventListener("click",()=>{re=null,Ve=null,gt(2)});break}case 2:{a==null||a.addEventListener("click",()=>{var x,k,$,R,z,U,q;const d=((x=document.querySelector("#onbFirstName"))==null?void 0:x.value.trim())||"",c=((k=document.querySelector("#onbLastName"))==null?void 0:k.value.trim())||"",p=(($=document.querySelector("#onbPhone"))==null?void 0:$.value.trim())||"",u=((R=document.querySelector("#onbCurrentRole"))==null?void 0:R.value.trim())||"",v=((z=document.querySelector("#onbSalaryUSD"))==null?void 0:z.value)||"",h=((U=document.querySelector("#onbSalaryCOP"))==null?void 0:U.value)||"",M=((q=document.querySelector("#onbLinkedin"))==null?void 0:q.value.trim())||"",A=document.querySelector("#onbBasicError");if(!d||!c||!p||!u){A&&(A.textContent="Please fill in your name, phone, and current role.");return}if(!v&&!h){A&&(A.textContent="Please enter an expected salary in USD, COP, or both.");return}P.firstName=d,P.lastName=c,P.phone=p,P.currentRole=u,P.expectedSalaryUSD=v?Number(v):"",P.expectedSalaryCOP=h?Number(h):"",P.linkedin=M,He(3)});break}case 3:{const d=document.querySelector("#onbRoleGroup"),c=document.querySelector("#onbTargetRole"),p=document.querySelector("#onbDept"),u=document.querySelector("#onbCity");d==null||d.addEventListener("change",()=>{c.innerHTML=ot(d.value,"")}),p==null||p.addEventListener("change",()=>{const v=me[p.value]||[];u.innerHTML=v.map(h=>`<option value="${w(h)}">${E(h)}</option>`).join("")}),a==null||a.addEventListener("click",()=>{var v;P.roleGroup=(d==null?void 0:d.value)||"",P.targetRole=(c==null?void 0:c.value)||"",P.department=(p==null?void 0:p.value)||"",P.city=(u==null?void 0:u.value)||"",P.english=((v=document.querySelector("#onbEnglish"))==null?void 0:v.value)||"",gt(4)});break}case 4:{(n=document.querySelector("#onbEdit"))==null||n.addEventListener("click",()=>He(1)),(s=document.querySelector("#onbFinish"))==null||s.addEventListener("click",bn),at(),bt(),St(),(i=document.querySelector("#onbAddExperience"))==null||i.addEventListener("click",()=>{P.experience.push({company:"",title:"",from:"",to:""}),at()}),(l=document.querySelector("#onbAddLanguage"))==null||l.addEventListener("click",()=>{P.languages.push(""),bt()}),(r=document.querySelector("#onbAddCertification"))==null||r.addEventListener("click",()=>{P.certifications.push({name:"",issuer:"",date:""}),St()}),ga();break}}}async function gt(e){var a,n;const t=document.querySelector("#onboardingWizard");if(Ve&&!_&&(t&&(t.innerHTML='<div class="onb-step"><p style="text-align:center;font-size:14px;font-weight:600;color:var(--green);padding:56px 0;">Analysing your CV…</p></div>'),_=await Ve),_!=null&&_.phone&&!P.phone&&(P.phone=_.phone),_!=null&&_.name&&!P.firstName&&!P.lastName){const s=String(_.name).trim().split(/\s+/).filter(Boolean);P.firstName=s[0]||"",P.lastName=s.slice(1).join(" ")}(n=(a=_==null?void 0:_.workHistory)==null?void 0:a[0])!=null&&n.title&&!P.currentRole&&(P.currentRole=_.workHistory[0].title),He(e)}async function bn(){var a,n,s,i,l,r,d;const e=document.querySelector("#onbFinish"),t=document.querySelector("#onbFinishErr");e&&(e.disabled=!0,e.innerHTML="Saving…");try{const c=P,p=(a=o.user)==null?void 0:a.uid;if(!p)throw new Error("Not signed in");const u=c.department||"",v=c.city||"",h=Number(c.expectedSalaryUSD||0)||null,M=Number(c.expectedSalaryCOP||0)||null,A=h||M||null,x=h?"USD":M?"COP":"USD",k=A?`${x} ${A.toLocaleString()}/mo`:"",$=[...document.querySelectorAll('[data-skill-search] input[name="skills"]')].map(q=>q.value),R=[c.firstName,c.lastName].filter(Boolean).join(" ")||((n=o.candidate)==null?void 0:n.name)||((s=o.user)==null?void 0:s.displayName)||"";let z={};if(re)try{const q=await ht(p,re,"");z={activeCvId:q.id,activeCvName:q.name||q.fileName,cvUrl:q.url,cvLibrary:[q]}}catch{}const U={name:R,firstName:c.firstName||"",lastName:c.lastName||"",targetRole:c.targetRole||"",headline:c.targetRole||"",currentRole:c.currentRole||"",department:u,city:v,location:[v,u].filter(Boolean).join(", "),locationCity:v,locationDepartment:u,locationCountry:"Colombia",locationId:`${String(v).toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9]+/g,"-")}-co`,english:c.english||"",salary:k,salaryUSD:h,salaryAmount:A,salaryCurrency:x,expectedSalaryUSD:h,expectedSalaryCOP:M,expectedSalaryAmount:A,expectedSalaryCurrency:x,whatsapp:c.phone||"",phone:c.phone||"",linkedin:c.linkedin||"",skills:[...new Set($.map(Pe).filter(Boolean))],workHistory:c.experience||[],certifications:(c.certifications||[]).filter(q=>q.name&&q.name.trim()),languages:(c.languages||[]).map(q=>q.trim()).filter(Boolean),summary:(_==null?void 0:_.summary)||"",email:((i=o.candidate)==null?void 0:i.email)||((l=o.user)==null?void 0:l.email)||"",candidateCode:(r=o.candidate)==null?void 0:r.candidateCode,marketingConsent:((d=o.candidate)==null?void 0:d.marketingConsent)===!0,availability:"open",onboarded:!0,...z};await Ct(p,U),window.history.pushState({page:"overview"},"","/"),S({candidate:{...o.candidate,...U},activePage:"overview",message:"Welcome to Nearwork! Your profile is ready."})}catch{t&&(t.textContent="Something went wrong. Please try again."),e&&(e.disabled=!1,e.innerHTML=`${m("check")} Finish setup`)}}function Sn(){const e=Qe(),t=o.jobs.map(Se).filter(i=>At(i,e).length>=3),a=e.length>=5,n=o.matchesFiltered&&a?t:o.jobs.map(Se),s=o.matchesFiltered&&!t.length;return`
  ...
  `}function $n(){const e=he(),t=o.assessments||[],a=t.filter(x=>["sent","started"].includes(String(x.status||"").toLowerCase())),n=t.filter(x=>String(x.status||"").toLowerCase()==="completed"),s=e?t.find(x=>x.id===e):a[0]||n[0]||null;if(o.assessmentUiStep==="techIntro"&&s)return Ln(s);if(o.assessmentUiStep==="discIntro"&&s)return Tn(s);if(e&&!s)return`
      <div class="nw-page-head">
        <div class="nw-page-overline">My journey</div>
  ...
  `}function kn(e,t){const a=(e.questions||[]).slice(0,70),n=ie(e,1).filter(r=>Me(pt(e,r))).length,s=ie(e,2).filter(r=>Me(pt(e,r))).length,i=ie(e,1).length||50,l=ie(e,2).length||20;return`
  ...
  `}function xn(e,t,a=null){var z,U,q;if(!t){const Z=w(e.role||"Role assessment"),Y=w(e.recruiterName||e.recruiter||"Nearwork"),f=it(e.expiresAt||e.deadline),g=ie(e,1).length||50,b=ie(e,2).length||20,C=Number(e.technicalMinutes||60),y=Number(e.discMinutes||30);return`
    ...
    `}const n=(e.questions||[]).slice(0,70),s=Math.min(a??Number(e.currentQuestionIndex||0),Math.max(n.length-1,0)),i=n[s],l=((U=(z=e.answers)==null?void 0:z[i.id])==null?void 0:U.value)??((q=e.answers)==null?void 0:q[i.id])??"",r=Array.isArray(i.options)&&i.options.length?i.options:["Strongly agree","Agree","Neutral","Disagree"],d=n[s+1],c=d==null?void 0:d.stage,p=c&&c!==i.stage,u=yt(e,i.stage),v=p&&u.length,h=s+1>=n.length,M=h?yt(e,i.stage):[],A=!!i.multiple,x=Number(i.stage||1)===2?"nw-assess-chip--violet":"nw-assess-chip--teal",k=A?"Multi-select":"Single choice",$=w(i.part||i.type||(Number(i.stage||1)===2?"DISC":"Scenario")),R=w(i.bank||"");return`
    <form id="assessmentQuestionForm" class="nw-assess-qcard" data-current-index="${s}">
      <div class="nw-assess-qmeta">
        <span class="nw-assess-chip ${x}">${$}</span>
  ...
  `}function En(e){return!(e!=null&&e.expiresAt)||String(e.status||"").toLowerCase()==="completed"?!1:Date.now()>new Date(e.expiresAt).getTime()}function Ln(e){const t=w(e.role||"Role assessment"),a=ie(e,1).length||50,n=Number(e.technicalMinutes||60);return`
    <div class="nw-assess-wrap">
      ${Lt(e)}
  ...
  `}function Tn(e){const t=ie(e,1).length||50,a=ie(e,2).length||20,n=Number(e.discMinutes||30),s=w(e.recruiterName||e.recruiter||"your recruiter"),i=(e.questions||[]).findIndex(l=>Number(l.stage||1)===2);return`
    <div class="nw-assess-wrap">
      ${Lt(e)}
      <div class="nw-assess-body">
  ...
  `}function Nn(e){var l,r;const a=(((l=o.candidate)==null?void 0:l.name)||((r=o.user)==null?void 0:r.displayName)||"").split(" ")[0]||"You",n=w(e.recruiterName||e.recruiter||"your recruiter"),s=ie(e,1).length||50,i=ie(e,2).length||20;return`
  ...
  `:""}function qn(e,t){const a=e.questions||[],n=a.filter(r=>r.stage===1),s=a.filter(r=>r.stage===2),i=n.filter(r=>{var d;return typeof r.correctIndex=="number"&&Number((d=t[r.id])==null?void 0:d.value)===r.correctIndex}).length,l=s.filter(r=>{var d;return Me(((d=t[r.id])==null?void 0:d.value)??t[r.id])}).length;return{technicalScore:n.length?Math.round(i/n.length*100):0,discScore:s.length?Math.round(l/s.length*100):0}}function In(e,t){var r,d;const a={Dominance:0,Influence:0,Steadiness:0,Conscientiousness:0};(e.questions||[]).filter(c=>Number(c.stage)===2).forEach(c=>{var h;const p=(h=t[c.id])==null?void 0:h.value;if(!Me(p))return;const u=a[c.skill]!==void 0?c.skill:"Steadiness",v=Math.max(1,4-Number(p||0));a[u]+=v});const n=Object.entries(a).sort((c,p)=>p[1]-c[1]),s=((r=n[0])==null?void 0:r[0])||"Steadiness",i=((d=n[n.length-1])==null?void 0:d[0])||"Dominance";return{label:{Dominance:"D",Influence:"I",Steadiness:"S",Conscientiousness:"C"}[s]||"S",high:s,low:i,scores:a,summary:`${s} is the strongest observed DISC tendency; ${i} appears lowest based on this assessment.`}}async function Dn(e,t){var d,c,p,u,v;const a="https://admin.nearwork.co/api/send-email",n=e.candidateEmail||((d=o.user)==null?void 0:d.email)||((c=o.candidate)==null?void 0:c.email),s=e.candidateName||((p=o.candidate)==null?void 0:p.name)||((u=o.user)==null?void 0:u.displayName)||"there",i=la([e.recruiterEmail,e.stakeholderEmail,e.hiringManagerEmail].filter(Boolean).join(",")),l=[];n&&l.push(fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({to:n,templateId:"assessment_completed_candidate",data:{name:s,role:e.role,actionUrl:"https://talent.nearwork.co/assessment",actionText:"Open assessment center"}})}));const r=i.length?i:["support@nearwork.co"];l.push(fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({to:r,templateId:"assessment_completed_recruiter",data:{name:"Nearwork team",role:e.role,actionUrl:`https://admin.nearwork.co/assessments/${e.id}/questions`,actionText:"Review assessment",message:`${s} completed the assessment. Overall: ${t.score}%. Technical: ${t.technicalScore}%. DISC: ${((v=t.discProfile)==null?void 0:v.label)||"Submitted"}.`}})})),await Promise.allSettled(l)}function _n(){var t;const e=((t=o.candidate)==null?void 0:t.cvLibrary)||[];return`
    <div class="nw-page-head">
      <div class="nw-page-overline">My search</div>
    ...
    <section class="nw-panel" style="margin-top:18px;padding-bottom:18px;">
      ...
      <div class="cv-list">
        ${e.length?e.map(a=>`<article class="cv-item">${m("file-text")}<div><strong>${a.name||a.fileName}</strong><span>${it(a.uploadedAt)}</span></div>${a.url?`<a href="${a.url}" target="_blank" rel="noreferrer">Open</a>`:""}</article>`).join(""):ma("No CVs saved yet","Upload role-specific resumes here.")}
      </div>
    </section>
  `}function Rn(){return`
    <div class="nw-page-head">
  ...
  `}function Un(){var a,n;const t=(((a=o.candidate)==null?void 0:a.recruiter)||{}).bookingUrl||((n=o.candidate)==null?void 0:n.recruiterBookingUrl)||"mailto:support@nearwork.co?subject=Nearwork%20candidate%20question";return`
    <div class="nw-page-head">
      <div class="nw-page-overline">Support</div>
  ...
  `}function Bn(){return On("profile")}function H(e,t=!1){return`<span class="pf-label">${e}${t?'<span class="pf-optional">optional</span>':""}</span>`}function ae(e,t,a=""){return`
    ...
    </div>`}const Fn=["","A1","A2","B1","B2","C1","C2","Native"];function Nt(e,t={}){const a=e,n=typeof t=="string"?{name:t,level:""}:t;return`
    ...
    </div>`}function On(e="profile"){var u,v,h,M,A,x,k,$,R,z,U,q,Z,Y,f,g,b,C;const t=Qe(),a=an(),n=me[a.department]||[],s=((u=o.candidate)==null?void 0:u.salaryCurrency)||"USD",i=oa(((v=o.candidate)==null?void 0:v.salaryAmount)||((h=o.candidate)==null?void 0:h.salary)||((M=o.candidate)==null?void 0:M.salaryUSD),s),l=nn(),r=((A=o.candidate)==null?void 0:A.targetRole)||((x=o.candidate)==null?void 0:x.headline)||"",d=ua(),c=Pt(),p=c.filter(y=>y.done).length;return`
    <div class="pf-page">
        ...
        <div class="pf-tab-panel" data-tab-panel="profile">
          ...
          <div class="pf-card">
            ...
            <div class="pf-identity-row">
              ...
              <div class="pf-field" style="flex:1;">
                ${H("Full name")}
                <input class="pf-input" name="name" value="${w(((k=o.candidate)==null?void 0:k.name)||(($=o.user)==null?void 0:$.displayName)||"")}" placeholder="Your full name" />
              </div>
            </div>
          </div>
          ...
          <div class="pf-card">
            ...
            <div class="pf-field-row">
              <label class="pf-field">
                ${H("WhatsApp number")}
                <input class="pf-input" name="whatsapp" value="${w(((z=o.candidate)==null?void 0:z.whatsapp)||((U=o.candidate)==null?void 0:U.phone)||"")}" inputmode="tel" autocomplete="tel" placeholder="+57 300 123 4567" required />
              </label>
              <label class="pf-field">
                ${H("LinkedIn",!0)}
  ...
  `}function ua(){const e=Pt(),t=e.filter(a=>a.done).length;return Math.max(25,Math.round(t/e.length*100))}function jn(){const e=o.applications[0];return(e==null?void 0:e.stage)||(e==null?void 0:e.status)||"profile-review"}function zn(e){const t=String(e).toLowerCase().replace(/_/g,"-").replace(/\s+/g,"-"),a=Math.max(0,_t.findIndex(n=>t.includes(n.key)||n.key.includes(t)));return`<div class="pipeline">${_t.map((n,s)=>`<article class="${s<=a?"done":""} ${s===a?"current":""}"><span>${s+1}</span><strong>${n.label}</strong><p>${n.help}</p></article>`).join("")}</div>`}function Hn(){return`
    <div class="nw-empty">
  ...
  `}function pa(){try{return new Set(JSON.parse(localStorage.getItem("nw_talent_applied")||"[]"))}catch{return new Set}}function Vn(e){const t=Se(e),n=new Set(o.applications.map(u=>u.jobId||u.openingCode)).has(t.code)||pa().has(t.code),s=At(t),i=t.match||(s.length>=3?Math.min(97,70+s.length*4):null),l=["#10A07C","#EC4E7E","#3B82F6","#F4A52E"],r=l[t.orgName.length%l.length],d=t.orgName.split(/\s+/).slice(0,2).map(u=>u[0]).join("").toUpperCase(),c=`https://jobs.nearwork.co/apply?code=${encodeURIComponent(t.code)}`,p=(s.length?s:t.skills).slice(0,3);return`
    <div class="nw-match-card">
      <div class="nw-match-card-top">
  ...
  `}function Gn(e,t){const a=String(e.stage||e.status||"applied").toLowerCase(),n=a.includes("offer")?4:a.includes("final")?3:a.includes("interview")?2:a.includes("assessment")?1:0,s=e.clientName||e.company||"Nearwork client",i=s.split(/\s+/).slice(0,2).map(c=>c[0]).join("").toUpperCase(),l=["#10A07C","#EC4E7E","#3B82F6","#F4A52E","#8B5CF6"],r=l[s.length%l.length],d=["action-needed","interview-scheduled","assessment-sent"].includes(String(e.status||"").toLowerCase());return`
    <div class="nw-app-row${t?" last":""}">
      ...
      <div class="nw-app-info">
        ...
        <div class="nw-app-stages">
          ${Kt.map((c,p)=>`<div class="nw-stage-pip${p<=n?" done":""}"></div>`).join("")}
    ...
    <div class="nw-modal" style="text-align:center;padding:32px 28px;">
    ...
    </div>`,document.body.appendChild(a),a.addEventListener("click",n=>{(n.target===a||n.target.id==="dismissApplySuccess")&&a.remove()}),document.getElementById("dismissApplySuccess").focus()}function Wn(){st.innerHTML='<main class="loading-screen"><span class="logo-mark">N</span><p>Loading Talent...</p></main>'}async function Yn(e){var t;try{const a=await((t=B.currentUser)==null?void 0:t.getIdToken().catch(()=>""));if(a){const n=await fetch("/api/auth-handoff",{method:"POST",headers:{Authorization:"Bearer "+a,"Content-Type":"application/json"}});if(n.ok){const{customToken:s}=await n.json();if(s){const i=new URL(e);i.searchParams.set("ct",s),window.open(i.toString(),"_blank","noreferrer");return}}}}catch{}window.open(e,"_blank","noreferrer")}function Zn(){var e,t,a,n,s,i,l,r,d,c,p,u,v,h,M,A,x,k,$,R,z,U,q,Z,Y;(e=document.querySelector("#signOut"))==null||e.addEventListener("click",async()=>{await ct(B),V&&V(),V=null,ze=!1,J=!1,oe=null,window.history.pushState({page:"overview"},"","/"),S({user:null,candidate:null,applications:[],assessments:[],jobs:[],view:"login",activePage:"overview",message:""})}),(t=document.querySelector("#mobileSignOut"))==null||t.addEventListener("click",async()=>{await ct(B),V&&V(),V=null,ze=!1,J=!1,oe=null,window.history.pushState({page:"overview"},"","/"),S({user:null,candidate:null,applications:[],assessments:[],jobs:[],view:"login",activePage:"overview",message:""})}),(a=document.querySelector("#signIn"))==null||a.addEventListener("click",()=>{window.history.pushState({page:"overview"},"","/"),S({view:"login",activePage:"overview",message:""})}),(n=document.querySelector("#openDeleteAccount"))==null||n.addEventListener("click",()=>{S({showDeleteAccountModal:!0,deleteAccountStatus:null,deleteAccountError:""})}),(s=document.querySelector("#cancelDeleteAccount"))==null||s.addEventListener("click",()=>{S({showDeleteAccountModal:!1,deleteAccountStatus:null,deleteAccountError:""})}),(i=document.querySelector("#confirmDeleteAccount"))==null||i.addEventListener("click",async()=>{var g,b;if(((b=(g=document.querySelector("#deleteConfirmInput"))==null?void 0:g.value)==null?void 0:b.trim())!=="DELETE"){S({deleteAccountStatus:"error",deleteAccountError:'Type "DELETE" to confirm.'});return}S({deleteAccountStatus:"deleting"});try{await Oa(),await ct(B),V&&V(),V=null,ze=!1,J=!1,oe=null,window.history.pushState({page:"overview"},"","/"),S({user:null,candidate:null,applications:[],assessments:[],jobs:[],view:"login",activePage:"overview",showDeleteAccountModal:!1,deleteAccountStatus:null,deleteAccountError:"",message:"Your account has been deleted. You're welcome to sign up again anytime."})}catch(C){S({deleteAccountStatus:"error",deleteAccountError:C.message||"Failed to delete account."})}}),document.querySelectorAll("[data-page]").forEach(f=>{f.addEventListener("click",g=>{const C=(g.currentTarget.closest("[data-page]")||g.currentTarget).dataset.page;if(o.activePage==="profile"&&J&&C!=="profile"){oe=C,S({showUnsavedChangesModal:!0});return}Oe(C)})}),(l=document.querySelector("[data-dashboard-home]"))==null||l.addEventListener("click",()=>{if(o.activePage==="profile"&&J){oe="overview",S({showUnsavedChangesModal:!0});return}Oe("overview")}),(r=document.querySelector("#cancelUnsavedNav"))==null||r.addEventListener("click",()=>{oe=null,S({showUnsavedChangesModal:!1})}),(d=document.querySelector("#discardUnsavedNav"))==null||d.addEventListener("click",()=>{J=!1;const f=oe;oe=null,S({showUnsavedChangesModal:!1}),f&&Oe(f)}),(c=document.querySelector("#saveUnsavedNav"))==null||c.addEventListener("click",()=>{var f;S({showUnsavedChangesModal:!1}),(f=document.querySelector("#profileForm"))==null||f.requestSubmit()}),(p=document.querySelector("#notificationBell"))==null||p.addEventListener("click",()=>{S({notificationPanelOpen:!o.notificationPanelOpen,notificationSettingsOpen:!1})}),(u=document.querySelector("#notificationSettings"))==null||u.addEventListener("click",()=>{S({notificationSettingsOpen:!o.notificationSettingsOpen,notificationPanelOpen:!1})}),document.querySelectorAll("[data-notification-read]").forEach(f=>{f.addEventListener("click",async()=>{const g=f.dataset.notificationRead;o.user&&we&&await Va(g).catch(()=>null),S({notifications:o.notifications.map(b=>b.id===g?{...b,read:!0}:b)})})}),document.querySelectorAll("[data-notification-pref]").forEach(f=>{f.addEventListener("change",async()=>{var y;const g=structuredClone(((y=o.candidate)==null?void 0:y.notificationPreferences)||{}),b=f.dataset.notificationPref,C=f.dataset.channel;g[b]={...g[b]||{},[C]:f.checked},S({candidate:{...o.candidate,notificationPreferences:g}}),o.user&&we&&await Ga(o.user.uid,g).catch(()=>null)})}),document.querySelectorAll("[data-assessment-jump]").forEach(f=>{f.addEventListener("click",async()=>{var K,X,D;const g=he()||((K=(o.assessments||[])[0])==null?void 0:K.id),b=(o.assessments||[]).find(I=>I.id===g),C=Number(f.dataset.assessmentJump||0),y=(X=b==null?void 0:b.questions)==null?void 0:X[C];if(!g||!y)return;await Fe(g,"__progress__","",{currentQuestionIndex:C,totalQuestions:((D=b==null?void 0:b.questions)==null?void 0:D.length)||70,currentStage:y.stage||1}),Te(g,C);const N=(o.assessments||[]).map(I=>I.id===g?{...I,currentQuestionIndex:C,currentStage:y.stage||1}:I);S({assessments:N,activePage:"assessment",message:""})})}),document.querySelector("#availability").addEventListener("change",async f=>{const g=f.target.value;S({candidate:{...o.candidate,availability:g}}),o.user&&we?await Fa(o.user.uid,g):S({message:"Sign in to save availability."})}),(v=document.querySelector("#filterMatches"))==null||v.addEventListener("click",()=>{const f=Qe().length>=3;S({matchesFiltered:f?!o.matchesFiltered:!1,message:f?"":"Add at least 5 skills in Profile first, then filter matching openings."})}),(h=document.querySelector("#departmentSelect"))==null||h.addEventListener("change",f=>{const g=document.querySelector("#citySelect"),b=me[f.target.value]||[];g.innerHTML=b.map(C=>`<option value="${w(C)}">${C}</option>`).join("")}),(M=document.querySelector("#roleGroupSelect"))==null||M.addEventListener("change",f=>{const g=document.querySelector("#targetRoleSelect");g.innerHTML=ot(f.target.value,"")}),(A=document.querySelector("#salaryCurrencyInput"))==null||A.addEventListener("change",f=>{const g=document.querySelector("#salaryInput");if(!g)return;const b=Ut(g.value,f.target.value);f.target.value=b,g.placeholder=b==="COP"?"5,000,000":"2,500",g.value=wt(g.value,b)}),(x=document.querySelector("#salaryInput"))==null||x.addEventListener("blur",f=>{const g=document.querySelector("#salaryCurrencyInput"),b=Ut(f.target.value,(g==null?void 0:g.value)||"USD");g&&(g.value=b),f.target.placeholder=b==="COP"?"5,000,000":"2,500",f.target.value=wt(f.target.value,b)}),fn(),ga(),is(),Xn(),ns(),ts(),Kn(),document.querySelectorAll("[data-open-url]").forEach(f=>{f.addEventListener("click",()=>Yn(f.dataset.openUrl))}),document.querySelectorAll("[data-apply]").forEach(f=>{f.addEventListener("click",async()=>{const g=o.jobs.map(Se).find(C=>C.code===f.dataset.apply),b=f.dataset.apply;if(f.disabled=!0,f.textContent="Submitting...",o.user&&we){try{const C=pa();C.add(b),localStorage.setItem("nw_talent_applied",JSON.stringify([...C]))}catch{}await Ba(o.user.uid,g),f.textContent=`${m("check")} Applied`,f.classList.add("applied"),Jn(g)}else S({message:"Sign in to apply to this opening."})})}),(k=document.querySelector("#showTechIntro"))==null||k.addEventListener("click",()=>{S({assessmentUiStep:"techIntro",message:""})}),($=document.querySelector("#backToWelcome"))==null||$.addEventListener("click",()=>{S({assessmentUiStep:null,message:""})}),(R=document.querySelector("#startDiscAssessment"))==null||R.addEventListener("click",async()=>{var X;const f=he()||((X=(o.assessments||[])[0])==null?void 0:X.id),g=(o.assessments||[]).find(D=>D.id===f);if(!f||!g)return;const b=g.questions||[],C=document.querySelector("#startDiscAssessment"),y=C?Number(C.dataset.discIndex||50):b.findIndex(D=>Number(D.stage||1)===2),N=y>=0?y:50,K=new Date().toISOString();try{await Fe(f,"__progress__","",{currentQuestionIndex:N,totalQuestions:b.length,currentStage:2,discStartedAt:K}),Te(f,N);const D=(o.assessments||[]).map(I=>I.id===f?{...I,currentQuestionIndex:N,currentStage:2,discStartedAt:K}:I);S({assessments:D,activePage:"assessment",assessmentUiStep:null,message:""})}catch(D){S({message:ke(D)})}}),(z=document.querySelector("#startAssessment"))==null||z.addEventListener("click",async()=>{var b;const f=he()||((b=(o.assessments||[])[0])==null?void 0:b.id),g=(o.assessments||[]).find(C=>C.id===f)||(o.assessments||[])[0];if(!f||!o.user){S({message:"Please log in to start your assessment."});return}try{await Ra(f,o.user.uid),Te(f,Number((g==null?void 0:g.currentQuestionIndex)||0),!0);const C=(o.assessments||[]).map(y=>y.id===f?{...y,status:"started",startedAt:y.startedAt||new Date().toISOString(),technicalStartedAt:y.technicalStartedAt||new Date().toISOString()}:y);S({assessments:C,activePage:"assessment",assessmentUiStep:null,message:""})}catch(C){S({message:ke(C)})}}),(U=document.querySelector("#prevAssessmentQuestion"))==null||U.addEventListener("click",async()=>{var K,X,D,I;const f=he()||((K=(o.assessments||[])[0])==null?void 0:K.id),g=(o.assessments||[]).find(le=>le.id===f),b=Number(((X=document.querySelector("#assessmentQuestionForm"))==null?void 0:X.dataset.currentIndex)??(g==null?void 0:g.currentQuestionIndex)??0),C=Math.max(0,b-1),y=(D=g==null?void 0:g.questions)==null?void 0:D[C];await Fe(f,"__progress__","",{currentQuestionIndex:C,totalQuestions:((I=g==null?void 0:g.questions)==null?void 0:I.length)||70,currentStage:(y==null?void 0:y.stage)||1}),Te(f,C);const N=(o.assessments||[]).map(le=>le.id===f?{...le,currentQuestionIndex:C,currentStage:(y==null?void 0:y.stage)||1}:le);S({assessments:N,activePage:"assessment",message:""})}),(q=document.querySelector("#assessmentQuestionForm"))==null||q.addEventListener("submit",async f=>{var De;f.preventDefault();const g=he()||((De=(o.assessments||[])[0])==null?void 0:De.id),b=(o.assessments||[]).find(O=>O.id===g),C=(b==null?void 0:b.questions)||[],y=Number(f.currentTarget.dataset.currentIndex??(b==null?void 0:b.currentQuestionIndex)??0),N=C[y],K=new FormData(f.currentTarget).get("answer");if(!N){S({message:"This question could not be loaded. Please refresh and try again."});return}const X=K===null?{value:"",skipped:!0,answeredAt:new Date().toISOString()}:{value:Number(K),skipped:!1,answeredAt:new Date().toISOString()},D={...b.answers||{},[N.id]:X},I=C[y+1],le=I&&Number(I.stage||1)!==Number(N.stage||1),Ee=yt(b,N.stage,D);try{if((le||y+1>=C.length)&&Ee.length){await Fe(g,N.id,D[N.id],{currentQuestionIndex:y,totalQuestions:C.length,currentStage:N.stage||1});const O=(o.assessments||[]).map(ee=>ee.id===g?{...ee,answers:D,currentQuestionIndex:y,currentStage:N.stage||1,progress:`${y+1}/${C.length}`}:ee);S({assessments:O,activePage:"assessment",message:`You missed ${Ee.length} question${Ee.length===1?"":"s"} in the ${xt(N.stage)}.`});return}if(y+1>=C.length){const O=qn(b,D),ee=In(b,D);await Ua(g,D,{totalQuestions:C.length,technicalScore:O.technicalScore,discScore:O.discScore,score:Math.round(O.technicalScore*.75+O.discScore*.25),discProfile:ee}),fetch("https://admin.nearwork.co/api/generate-assessment-insights",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({assessmentId:g})}).catch(()=>null),Dn(b,{score:Math.round(O.technicalScore*.75+O.discScore*.25),technicalScore:O.technicalScore,discScore:O.discScore,discProfile:ee}).catch(ve=>console.warn(ve));const ge=(o.assessments||[]).map(ve=>ve.id===g?{...ve,answers:D,status:"completed",score:Math.round(O.technicalScore*.75+O.discScore*.25),technical:O.technicalScore,disc:ee.label,discProfile:ee,progress:`${C.length}/${C.length}`}:ve);S({assessments:ge,activePage:"assessment",message:""})}else{const O=N.stage===1&&(I==null?void 0:I.stage)===2&&!b.discStartedAt;await Fe(g,N.id,D[N.id],{currentQuestionIndex:y+1,totalQuestions:C.length,currentStage:(I==null?void 0:I.stage)||N.stage||1}),Te(g,y+1);const ee=(o.assessments||[]).map(ge=>ge.id===g?{...ge,answers:D,currentQuestionIndex:y+1,currentStage:(I==null?void 0:I.stage)||N.stage||1,progress:`${y+1}/${C.length}`}:ge);S({assessments:ee,activePage:"assessment",message:"",assessmentUiStep:O?"discIntro":null})}}catch(O){S({message:ke(O)})}}),(Z=document.querySelector("#profileForm"))==null||Z.addEventListener("submit",async f=>{var X,D,I,le,Ee,De,O,ee,ge,ve;f.preventDefault();const g=new FormData(f.currentTarget),b=g.get("department"),C=g.get("city"),y=oa(g.get("salary"),g.get("salaryCurrency")),N=g.get("marketingConsent")==="on",K={name:g.get("name"),targetRole:g.get("targetRole"),headline:g.get("targetRole"),department:b,city:C,locationId:`${String(C).toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-z0-9]+/g,"-")}-co`,location:`${C}, ${b}`,locationCity:C,locationDepartment:b,locationCountry:"Colombia",english:g.get("english"),salary:y.salary,salaryUSD:y.salaryUSD,salaryAmount:y.salaryAmount,salaryCurrency:y.salaryCurrency,expectedSalaryAmount:y.salaryAmount,expectedSalaryCurrency:y.salaryCurrency,linkedin:g.get("linkedin"),whatsapp:g.get("whatsapp"),phone:g.get("whatsapp"),skills:[...new Set(g.getAll("skills").map(Pe).filter(Boolean))],otherSkills:[],languages:as(),summary:g.get("summary"),email:((X=o.candidate)==null?void 0:X.email)||((D=o.user)==null?void 0:D.email)||"",availability:((I=o.candidate)==null?void 0:I.availability)||"open",marketingConsent:N,marketingConsentAt:N?((le=o.candidate)==null?void 0:le.marketingConsent)===!0?((Ee=o.candidate)==null?void 0:Ee.marketingConsentAt)||null:new Date().toISOString():null,onboarded:!0};if(!o.user){S({candidate:{...o.candidate,...K},message:"Preview updated. Sign in to save this profile."});return}try{const Le=g.get("photo");let qt=((De=o.candidate)==null?void 0:De.photoURL)||((O=o.user)==null?void 0:O.photoURL)||"";Le!=null&&Le.name&&(qt=await za(o.user.uid,Le));const Je=(ee=g.get("profileCv"))!=null&&ee.name?g.get("profileCv"):et;let Ce=null,It=!1;if(Je!=null&&Je.name)try{Ce=await ht(o.user.uid,Je,g.get("profileCvLabel")||""),et=null}catch{It=!0}const rt={...K,photoURL:qt,candidateCode:(ge=o.candidate)==null?void 0:ge.candidateCode,...Ce?{activeCvId:Ce.id,activeCvName:Ce.name||Ce.fileName,cvUrl:Ce.url,cvLibrary:[...((ve=o.candidate)==null?void 0:ve.cvLibrary)||[],Ce]}:{},workHistory:(()=>{var _e,Re,Ue,Be;const $e=es();return $e.length?$e:(_e=ne==null?void 0:ne.workHistory)!=null&&_e.length&&(Ne||!((Ue=(Re=o.candidate)==null?void 0:Re.workHistory)!=null&&Ue.length))?ne.workHistory:((Be=o.candidate)==null?void 0:Be.workHistory)||[]})(),certifications:(()=>{var _e,Re,Ue,Be;const $e=ss();return $e.length?$e:(_e=ne==null?void 0:ne.certifications)!=null&&_e.length&&(Ne||!((Ue=(Re=o.candidate)==null?void 0:Re.certifications)!=null&&Ue.length))?ne.certifications:((Be=o.candidate)==null?void 0:Be.certifications)||[]})()};ne=null,Ne=!1;const lt=await Ct(o.user.uid,rt),fa=It?"Profile saved, but the CV failed to upload. Try uploading it again from the CV section.":(lt==null?void 0:lt.atsSynced)===!1?"Profile saved. Nearwork will finish connecting it to your workspace.":"Profile saved.";if(g.get("mode")==="onboarding")window.history.pushState({page:"overview"},"","/"),S({candidate:{...o.candidate,...rt},activePage:"overview",message:"Profile complete. Welcome to Talent."});else if(J=!1,S({candidate:{...o.candidate,...rt},message:fa,showUnsavedChangesModal:!1}),oe){const $e=oe;oe=null,Oe($e)}}catch(Le){S({message:ke(Le)})}}),(Y=document.querySelector("#cvForm"))==null||Y.addEventListener("submit",async f=>{var C;f.preventDefault();const g=new FormData(f.currentTarget),b=g.get("cv");if(b!=null&&b.name){if(!o.user){S({message:"Sign in to upload and store CVs."});return}try{const y=await ht(o.user.uid,b,g.get("label"));S({candidate:{...o.candidate,cvLibrary:[...((C=o.candidate)==null?void 0:C.cvLibrary)||[],y],activeCvId:y.id},message:"CV uploaded."})}catch(y){S({message:ke(y)})}}})}function Kn(){var s;const e=document.querySelectorAll(".pf-tab"),t=document.querySelectorAll(".pf-tab-panel");if(!e.length||!t.length)return;const a=i=>{e.forEach(l=>l.classList.toggle("active",l.dataset.tab===i)),t.forEach(l=>{l.hidden=l.dataset.tabPanel!==i})};e.forEach(i=>{i.addEventListener("click",()=>a(i.dataset.tab))}),(s=document.querySelector("#profileForm"))==null||s.addEventListener("invalid",i=>{const l=i.target.closest(".pf-tab-panel");l&&a(l.dataset.tabPanel)},!0);const n=document.querySelector("#profileForm");n==null||n.addEventListener("input",()=>{J=!0}),n==null||n.addEventListener("change",()=>{J=!0})}function Xn(){const e=document.querySelector("#workHistoryCard");if(!e)return;let t=e.querySelectorAll(".work-entry").length;e.addEventListener("click",a=>{var s;const n=a.target.closest(".remove-work-entry");if(n){(s=n.closest(".work-entry"))==null||s.remove(),J=!0;return}if(a.target.closest("#addWorkEntry")){const i=document.querySelector("#workEntries");if(!i)return;const l=document.createElement("div");l.innerHTML=Tt(t++,{}),i.appendChild(l.firstElementChild),J=!0}})}function es(){return[...document.querySelectorAll(".work-entry")].map(e=>{const t=a=>{var n,s;return((s=(n=e.querySelector(`[data-field="${a}"]`))==null?void 0:n.value)==null?void 0:s.trim())||""};return{title:t("title"),company:t("company"),from:t("from"),to:t("to")}}).filter(e=>e.title||e.company)}function ts(){const e=document.querySelector("#langCard");if(!e)return;let t=e.querySelectorAll(".lang-entry").length;e.addEventListener("click",a=>{var s;const n=a.target.closest(".remove-lang-entry");if(n){(s=n.closest(".lang-entry"))==null||s.remove(),J=!0;return}if(a.target.closest("#addLangEntry")){const i=document.querySelector("#langEntries");if(!i)return;const l=document.createElement("div");l.innerHTML=Nt(t++,{}),i.appendChild(l.firstElementChild),J=!0}})}function as(){return[...document.querySelectorAll(".lang-entry")].map(e=>{const t=a=>{var n,s;return((s=(n=e.querySelector(`[data-field="${a}"]`))==null?void 0:n.value)==null?void 0:s.trim())||""};return{name:t("name"),level:t("level")}}).filter(e=>e.name)}function ns(){const e=document.querySelector("#certCard");if(!e)return;let t=e.querySelectorAll(".cert-entry").length;e.addEventListener("click",a=>{var s;const n=a.target.closest(".remove-cert-entry");if(n){(s=n.closest(".cert-entry"))==null||s.remove(),J=!0;return}if(a.target.closest("#addCertEntry")){const i=document.querySelector("#certEntries");if(!i)return;const l=document.createElement("div");l.innerHTML=Mt(t++,{}),i.appendChild(l.firstElementChild),J=!0}})}function ss(){return[...document.querySelectorAll(".cert-entry")].map(e=>{const t=a=>{var n,s;return((s=(n=e.querySelector(`[data-field="${a}"]`))==null?void 0:n.value)==null?void 0:s.trim())||""};return{name:t("name"),issuer:t("issuer"),date:t("date")}}).filter(e=>e.name)}function is(){var n,s,i,l,r,d;const e=document.querySelector("#profileForm"),t=e==null?void 0:e.querySelector('input[name="profileCv"]');if(!e||!t)return;((n=e.querySelector('input[name="mode"]'))==null?void 0:n.value)==="onboarding"&&!((i=(s=o.candidate)==null?void 0:s.skills)!=null&&i.length)&&!((r=(l=o.candidate)==null?void 0:l.workHistory)!=null&&r.length)&&!((d=o.candidate)!=null&&d.name)?os(e,t):rs(t)}function os(e,t){var l;const a=document.querySelector("#profileCvCard");if(!a)return;const n=[...e.children].filter(r=>r!==a&&r.type!=="hidden"&&r.getAttribute("name")!=="mode");n.forEach(r=>{r.style.display="none"});const s=document.createElement("p");s.id="cvGatePrompt",s.style.cssText="font-size:13px;color:var(--mid);margin:10px 0 4px;text-align:center;",s.innerHTML=`Upload your CV and we'll fill in the rest for you — or <button type="button" id="skipCvParse" style="background:none;border:none;padding:0;font-size:13px;color:var(--green);cursor:pointer;text-decoration:underline;">skip and fill in manually</button>`,a.insertAdjacentElement("afterend",s);function i(){var r,d;(r=document.querySelector("#cvGatePrompt"))==null||r.remove(),(d=document.querySelector("#cvParseLoading"))==null||d.remove(),n.forEach(c=>{c.style.display=""})}(l=document.querySelector("#skipCvParse"))==null||l.addEventListener("click",i),t.addEventListener("change",async()=>{var p,u;const r=(p=t.files)==null?void 0:p[0];if(!r)return;(u=document.querySelector("#cvGatePrompt"))==null||u.remove();const d=document.createElement("p");d.id="cvParseLoading",d.style.cssText="font-size:13px;font-weight:600;color:var(--green);padding:14px 0;text-align:center;",d.textContent="Analysing your CV…",a.insertAdjacentElement("afterend",d),ne=null,Ne=!0;const c=await $t(r);i(),c&&(ne=c,ls(c,!0),cs(c,t))})}function rs(e){e.addEventListener("change",async()=>{var r,d,c,p,u,v,h,M,A;const t=(r=e.files)==null?void 0:r[0];if(!t)return;ne=null,Ne=!1,et=null,S({message:"⏳ Analysing your CV — this takes up to 30 seconds…"});const a=await $t(t);if(!a){S({message:"⚠️ Could not read your CV. Check the browser console for details, or try a different file."});return}ne=a,Ne=!0,et=t;const n=o.candidate||{},s={...n,...a.name?{name:a.name}:{},...a.phone?{whatsapp:a.phone,phone:a.phone}:{},...a.summary?{summary:a.summary}:{},skills:(d=a.skills)!=null&&d.length?[...new Set(a.skills.map(Pe).filter(Boolean))]:n.skills||[],workHistory:(c=a.workHistory)!=null&&c.length?a.workHistory:n.workHistory||[],certifications:(p=a.certifications)!=null&&p.length?a.certifications:n.certifications||[],languages:(u=a.languages)!=null&&u.length?a.languages:n.languages||[]},i=[];a.name&&i.push("name"),a.phone&&i.push("phone"),a.summary&&i.push("summary"),(v=a.skills)!=null&&v.length&&i.push(`${a.skills.length} skill${a.skills.length!==1?"s":""}`),(h=a.workHistory)!=null&&h.length&&i.push(`${a.workHistory.length} role${a.workHistory.length!==1?"s":""}`),(M=a.certifications)!=null&&M.length&&i.push(`${a.certifications.length} cert${a.certifications.length!==1?"s":""}`),(A=a.languages)!=null&&A.length&&i.push("languages");const l=i.length?`✓ Pre-filled from CV: ${i.join(", ")}. Review and save your profile.`:"✓ CV analysed. Review your profile and save.";S({candidate:s,message:l})})}function ls(e,t){var n,s,i,l,r;const a=(d,c)=>{const p=document.querySelector(d);p&&c&&t&&(p.value=c)};if(a('input[name="name"]',e.name),a('input[name="whatsapp"]',e.phone),a('textarea[name="summary"]',e.summary),(n=e.skills)!=null&&n.length){const d=document.querySelector("#selectedSkills");if(d){d.innerHTML="";const c=new Set([...d.querySelectorAll('input[name="skills"]')].map(u=>u.value.toLowerCase()));(s=d.querySelector(".skill-empty"))==null||s.remove(),[...new Set(e.skills.map(Pe).filter(Boolean))].forEach(u=>{if(c.has(u.toLowerCase()))return;c.add(u.toLowerCase());const v=document.createElement("span");v.className="selected-skill",v.setAttribute("data-skill-chip",u),v.innerHTML=`${E(u)}<button type="button" class="skill-remove" data-remove-skill="${w(u)}" aria-label="Remove ${w(u)}">×</button><input type="hidden" name="skills" value="${w(u)}" />`,d.appendChild(v)})}}if((i=e.workHistory)!=null&&i.length){const d=document.querySelector("#workEntries");if(d){d.innerHTML="";let c=d.querySelectorAll(".work-entry").length;e.workHistory.forEach(p=>{const u=document.createElement("div");u.innerHTML=Tt(c++,p),d.appendChild(u.firstElementChild)})}}if((l=e.languages)!=null&&l.length){const d=document.querySelector("#langEntries");if(d){d.innerHTML="";let c=d.querySelectorAll(".lang-entry").length;e.languages.forEach(p=>{const u=document.createElement("div");u.innerHTML=Nt(c++,p),d.appendChild(u.firstElementChild)})}}if((r=e.certifications)!=null&&r.length){const d=document.querySelector("#certEntries");if(d){d.innerHTML="";let c=d.querySelectorAll(".cert-entry").length;e.certifications.forEach(p=>{const u=document.createElement("div");u.innerHTML=Mt(c++,p),d.appendChild(u.firstElementChild)})}}Ie()}function cs(e,t){var s,i,l,r,d;const a=[];e.name&&a.push("name"),e.phone&&a.push("phone"),(s=e.skills)!=null&&s.length&&a.push(`${e.skills.length} skill${e.skills.length>1?"s":""}`),(i=e.workHistory)!=null&&i.length&&a.push(`${e.workHistory.length} role${e.workHistory.length>1?"s":""}`),(l=e.certifications)!=null&&l.length&&a.push(`${e.certifications.length} cert${e.certifications.length>1?"s":""}`),(r=e.languages)!=null&&r.length&&a.push("languages"),(d=document.querySelector("#cvParseHint"))==null||d.remove();const n=document.createElement("p");n.id="cvParseHint",n.style.cssText="font-size:12px;color:var(--green);margin:4px 0 0;",n.innerHTML=a.length?`✓ Pre-filled: <strong>${a.join(", ")}</strong>. Review and save.`:"✓ CV analysed. Review your profile and save.",t.insertAdjacentElement("afterend",n)}function ga(){var d;const e=document.querySelector("[data-skill-search]");if(!e)return;const t=e.querySelector("#skillSearchInput"),a=e.querySelector("#skillSuggestions"),n=e.querySelector("#selectedSkills"),s=()=>[...n.querySelectorAll('input[name="skills"]')].map(c=>c.value),i=c=>{n.innerHTML=c.length?c.map(p=>`
      ...
      </span>`).join(""):'<span class="skill-empty">Selected skills will appear here.</span>'},l=()=>{const c=Q(t.value),p=t.value.trim(),u=new Set(s().map(Q)),v=Zt.filter(x=>!u.has(Q(x))).filter(x=>!c||Q(x).includes(c)).slice(0,12),h=v.find(x=>Q(x)===c),A=p.length>1&&!u.has(Q(p))&&!h?`<button type="button" class="skill-suggestion add-custom" data-skill="${w(p)}">+ Add "${E(p)}"</button>`:"";a.innerHTML=A+v.map(x=>`<button type="button" class="skill-suggestion" data-skill="${w(x)}">${E(x)}</button>`).join("")},r=c=>{const p=(c||t.value).trim(),u=Pe(p);if(!u)return;const v=Q(u),h=s();if(h.length>=20&&!h.some(A=>Q(A)===v)){t.value="";return}const M=[...h.filter(A=>Q(A)!==v),u];i(M),t.value="",l(),J=!0};t==null||t.addEventListener("input",l),t==null||t.addEventListener("focus",l),t==null||t.addEventListener("keydown",c=>{if(c.key!=="Enter")return;c.preventDefault();const p=Q(t.value),u=[...a.querySelectorAll(".skill-suggestion:not(.add-custom)")].find(v=>Q(v.dataset.skill)===p);r((u==null?void 0:u.dataset.skill)||t.value)}),(d=e.querySelector("#addTypedSkill"))==null||d.addEventListener("click",()=>r(t.value)),a.addEventListener("click",c=>{const p=c.target.closest("[data-skill]");p&&r(p.dataset.skill)}),n.addEventListener("click",c=>{const p=c.target.closest("[data-remove-skill]");if(!p)return;const u=Q(p.dataset.removeSkill);i(s().filter(v=>Q(v)!==u)),l(),J=!0})}function va(){if(o.loading)return Wn();if(o.view==="reset-password")return on();if(o.view==="dashboard")return da();ca()}window.addEventListener("popstate",()=>{if(window.location.pathname==="/reset-password"){S({view:"reset-password",resetCodeStatus:null,resetCodeError:""});return}const e=tt();e==="overview"&&!o.user?S({view:"login",activePage:"overview",message:""}):o.view==="dashboard"?Oe(e,!1):je()});const nt=new URLSearchParams(window.location.search).get("ct");nt&&window.history.replaceState({},"",window.location.pathname);let Ke=!!nt;we?(ba(B,e=>{if(!Ke)if(e)Bt(e);else{try{localStorage.removeItem("nw_talent_applied")}catch{}je()}}),window.setTimeout(()=>{o.loading&&(Ke=!1,je())},2500),nt&&Qa(nt).then(e=>{Ke=!1,Bt(e.user)}).catch(()=>{Ke=!1,je()})):je();
